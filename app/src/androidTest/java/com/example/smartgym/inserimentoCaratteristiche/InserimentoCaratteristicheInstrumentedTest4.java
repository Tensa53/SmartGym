...
@LargeTest
public class InserimentoCaratteristicheInstrumentedTest4 {
    ...
    public void inserimentoCaratteristicheTest() {
        ...
        onView(ViewMatchers.withId(R.id.etPeso)).perform(typeText("200"));
        onView(withId(R.id.etAltezza)).perform(clearText());
        onView(withId(R.id.etAltezza)).perform(typeText("240"));
